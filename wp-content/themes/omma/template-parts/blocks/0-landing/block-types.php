...
<section class="block-types py-5" id="about" data-progress-nav-anchor="" data-stack-section="">
	<div class="container">
		<div class="d-flex flex-column flex-lg-row gap-3 align-items-lg-stretch" data-stack-wrap="">
			...
			?>
				...
				<div class="block-types__item bg-blue-800 rounded-3 border border-blue-800" style="--bs-bg-opacity: .6"
					data-stack-card="">

					<!-- ── Etiqueta comprimida (desktop, estado cerrado) ─────────── -->
					<div class="block-types__label">
						<?php if ($title) : ?>
							<span class="block-types__label-text text-vanilla text-uppercase">
					...
					<!-- ── Contenido expandido ────────────────────────────────────── -->
					<div class="block-types__content p-4 p-lg-5">
					...
					</div><!-- /.block-types__content -->

				</div><!-- /.block-types__item -->
