...
if (!function_exists('omma_posted_on')) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function omma_posted_on()
	{
...
if (!function_exists('omma_posted_by')) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function omma_posted_by()
	{
		$byline = sprintf(
...
if (!function_exists('omma_entry_footer')) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function omma_entry_footer()
	{
...
if (!function_exists('omma_post_thumbnail')) :
	/**
