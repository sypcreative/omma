...
function datalayerOnLoad()
{
	...
	$paginas_categoria  = $has_acf ? (get_field('ga_datalayer_paginas_categoria') ?? '') : '';
	$paginas_seccion    = $has_acf ? (get_field('ga_datalayer_paginas_seccion') ?? '') : '';
	$paginas_subseccion = $has_acf ? (get_field('ga_datalayer_paginas_subseccion') ?? '') : '';
	$paginas_tipo       = $has_acf ? (get_field('ga_datalayer_paginas_tipo') ?? '') : '';
